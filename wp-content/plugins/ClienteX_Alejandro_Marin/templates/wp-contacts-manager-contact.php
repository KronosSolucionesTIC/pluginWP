﻿﻿﻿<?php wp_enqueue_style('admin-style-css'); ?>
    ...
    <div ng-app="ajaxExample" ng-cloak class="content-area">
        <div ng-controller="mainController">
            ...
            <div class="col-init-12">
                ...
                <div class="col-init-4 left"><?php esc_attr_e('Search', $this->text_domain); ?>:
                    <input type="text" ng-model="search" ng-change="filter()" placeholder="<?php esc_attr_e('Search', $this->text_domain); ?>" class="form-control" />
				    <a class="btn-init btn-info-init" id="btnExport" title="<?php esc_attr_e('This function only runs with PRO version - More Info - ', $this->text_domain); ?>"><i class="fa fa-file-excel-o"></i> <?php esc_attr_e(' Excel', $this->text_domain); ?></a>	
				</div>
				<div id="ExcelProWarning" class="col-init-2 left alert warning">
					<p><?php esc_attr_e('This function and other fields only runs with', $this->text_domain); ?><br>			
					<a target="_blank" href="https://wpcontactsmanager.com"><?php esc_attr_e('PRO version - MORE INFO -', $this->text_domain); ?></a></p>
				</div>
                ...
                <table id="contacts-list-manager">
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><?php esc_attr_e('Notes', $this->text_domain); ?>&nbsp;<a ng-click="sort_by('notes');"><i class="fa fa-sort"></i></a></th>                          
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                        <tr ng-repeat="data in filtered = (people| filter:search | orderBy : predicate :reverse) | startFrom:(currentPage - 1) * entryLimit | limitTo:entryLimit">
                            ...
                            <td style="cursor: pointer;" title="{{data.notes}}">{{data.notes}}</td>
                        </tr>
                    </tbody>
                </table>
                <div class="total-item">
