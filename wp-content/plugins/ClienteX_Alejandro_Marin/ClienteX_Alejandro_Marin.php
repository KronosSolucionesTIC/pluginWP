<?php
/**
 *   Plugin Name: Cliente X Alejandro Marin
 *   Plugin URI: https://github.com/KronosSolucionesTIC/ClienteX_Alejandro_Marin
 *   Description: Plugin basico para WordPress. 
 *   Version: 2.0
 *   Author: Alejandro Marin
 *   Author URI: https://github.com/KronosSolucionesTIC/
 *   License: GPL-2.0+
 *   License URI: http://www.gnu.org/licenses/gpl-2.0.txt
 *   Text Domain: ClienteX_Alejandro_Marin
...
class WP_Contacts_Manager {
    ...
    public function WP_Contacts_Manager_Save($postdata) {
        ...
        if (isset($postdata) && !empty($postdata)) {
            ...
            $newTwo_Email = isset($request->newTwo_Email) ? $request->newTwo_Email : '';
    ...
    public function WP_Contacts_Manager_Contact_Edit_Save($postdata) {
        ...
        if (isset($postdata) && !empty($postdata)) {
            ...
            $notes = isset($request->editnotes) ? $request->editnotes : '';
			$newTwo_Email = isset($request->editnewTwo_Email) ? $request->editnewTwo_Email : '';
